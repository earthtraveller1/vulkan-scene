    ...
    -> kirho::result_t<VkInstance, VkResult>
{
    ...
    {
        constexpr auto VK_LAYER_KHRONOS_validation =
    ...
    {
        std::cerr << "[error]: failed to create instance vulkan error "
                  << result_t << '\n';
    ...
    for (const auto device : physical_devices)
    {
             ...
             i++)
        {
            ...
            vkGetPhysicalDeviceSurfaceSupportKHR(
                device, static_cast<uint32_t>(i), p_surface, &present_support
            );
    ...
    -> kirho::result_t<VkDebugUtilsMessengerEXT, VkResult>
{
    ...
    {
        print_error(
            "Failed to create the debug messenger. Vulkan error ", result_t, "."
        );
        return result_t_t::error(result_t);
    }
...
) noexcept -> kirho::result_t<logical_device, VkResult>
{
    ...
    {
        print_error(
            "Failed to create the logical device. Vulkan error ", result_t, "."
        );
        return result_t_t::error(result_t);
    }
